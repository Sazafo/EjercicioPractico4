...
public class Maraton {
    ...
    //este metodo es para el registro del corredor 
    ...
    public void generarParticipantesIniciales() {
        participantes[0] = new Participante("Santiago Zamora", 25, 1, 120);
        participantes[1] = new Participante("Joel Cambell", 17, 2, 130);
        participantes[2] = new Participante("Pikachu OnePice", 45, 3, 140);
        contador = 3;
    }
}
